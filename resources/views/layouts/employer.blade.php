...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Best For You HR Consultancy Employer</title>
...
<header id="header-admin-wrap" class="header-admin-fixed">
                                	...
                                	<div class="listing-user">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="ID-ACCOUNT_dropdown">
                                                ...
                                                <ul>
                                                    <li><a href="{{ route('employer.index') }}"><i class="fa fa-home"></i>Dashboard</a></li>
        ...
        <nav id="sidebar-admin-wraper">
            <div class="page-logo">
                <a href="{{ route('employer.index') }}"><img src="{{ asset('images/logo-dark.svg') }}" alt=""></a>
            </div>

            <div class="admin-nav scrollbar-macosx">
                <ul>
                    <li class="active">
                        <a href="{{ route('employer.index') }}"><i class="fa fa-home"></i><span class="admin-nav-text">Dashboard</span></a>
                    </li>
               ...
               <li>
                        ...
                        <ul class="sub-menu">
                        	<li> <a href="{{ route('jobs.create') }}"><span class="admin-nav-text">Post a New Jobs</span></a></li>
                        	<li> <a href="{{ route('jobs.index') }}"><span class="admin-nav-text">Manage Jobs</span></a></li>

                        </ul>
                    </li>

                    <li>
                        <a href="{{ route('employer.change.password.form') }}"><i class="fa fa-fingerprint"></i><span class="admin-nav-text">Change Password</span></a>
                    </li>
        ...
        <div class="modal fade twm-model-popup" id="logout-dash-profile" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button"  class="site-button outline-primary"><a href="{{ route('employer.logout') }}">Yes</a></button>
                </div>
            </div>
            </div>
        </div>
