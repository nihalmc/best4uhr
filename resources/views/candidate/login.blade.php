...
<body>
                                ...
                                <div class="twm-log-reg-inner">
                                    ...
                                    <div class="twm-tabs-style-2">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                          ...
                                          <!-- Admin login tab -->
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab"     type="button"><i class="fas fa-user-tie"></i>Job Seekers</a>
    </li>
</ul>
                       @if(session('error'))
    ...
    <div class="col-lg-12">
        ...
        <div class="form-group ">
              <a href="{{route('candidate.register')}}">Don't have an account ? <span class="login-here-text">Sign Up</span></a>
              </div>
                   </div>
