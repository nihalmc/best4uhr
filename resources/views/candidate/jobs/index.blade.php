...
<!-- <div class="form-group mb-4">
                                ...
                                <div class="widget tw-sidebar-tags-wrap">
                                    ...
                                    <div class="tagcloud">
                                        <a href="{{ route('candidate.jobs.index') }}">General</a>
                                        <a href="{{ route('candidate.jobs.index') }}">Jobs </a>
                                        <a href="{{ route('candidate.jobs.index') }}">Payment</a>
                                        <a href="{{ route('candidate.jobs.index') }}">Application </a>
                                        <a href="{{ route('candidate.jobs.index') }}">Work</a>
                                        <a href="{{ route('candidate.jobs.index') }}">Recruiting</a>
                                        <a href="{{ route('candidate.jobs.index') }}">Employer</a>
                                        <a href="{{ route('candidate.jobs.index') }}">Income</a>
                                        <a href="{{ route('candidate.jobs.index') }}">Tips</a>
                                    </div>
                                </div>
...
@csrf
                                     ...
                                     <li>
                                         <div class="twm-jobs-list-style1 mb-1">
                                             ...
                                             <div class="twm-mid-content">
                                                 <a href="{{ route('candidate.job-detail', $job->id) }}" class="twm-job-title">
  ...
  <!--<div class="form-group mb-4">
            ...
            " >{{ $job->status }}</span></div> <div class="twm-jobs-amount"> {{ $job->salary }}<span>/ Month</span></div>
                                                 <a href="{{ route('candidate.job-detail', $job->id) }}" class="twm-jobs-browse site-text-primary">View and Apply</a>
                                             </div>
                                         </div>
                                     </li>
                                     @endforeach
