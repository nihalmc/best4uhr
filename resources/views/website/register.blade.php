...
<body>
 ...
 <div class="section-full site-bg-white">
                                ...
                                <div class="twm-log-reg-inner">
                                    ...
                                    <div class="twm-tabs-style-2">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                            ...
                                            <!--Login Employer-->
                                            <li class="nav-item">
                                                <button class="nav-link" data-bs-toggle="tab"  type="button"><i class="fas fa-building"></i>Employer</button>
                                            </li>
        ...
        <div class="form-group ">
              <a href="{{ route('employer.login') }}">Already have an account? <span class="login-here-text">Login Here</span></a>
              </div>
                   </div>
