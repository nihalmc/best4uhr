    ...
    <div id="content">
        ...
        <div class="content-admin-main">
            ...
            <div class="wt-admin-right-page-header clearfix">
                ...
                <div class="breadcrumbs"><a href="#">Home</a><a href="{{ route('employer.index') }}">Dashboard</a><span>Change Password</span></div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body wt-panel-body p-a20">
                    <form method="post" action="{{ route('employer.change.password.form') }}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="ls-inputicon-box">
                                        <input class="form-control wt-form-control" name="new_password" id="new_password" type="password" placeholder="">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="ls-inputicon-box">
                                        <input class="form-control wt-form-control" type="password" name="confirm_password" id="confirm_password" placeholder="">
